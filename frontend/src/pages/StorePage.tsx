...
import { storeApi, type StoreFormPayload, type StorePageVO } from '@/shared/api/modules/systemApi';
...
export function StorePage() {
  ...
  const [form, setForm] = useState<StoreFormPayload>({
    name: '',
    openTime: '09:00',
    closeTime: '21:00',
    ...
    <div className="space-y-4">
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div>
          ...
          <p className="text-sm text-zinc-500">门店与部门 1:1；新建不填部门时会自动建同名组织节点。</p>
        </div>
      ...
      {loading ? (
        ...
        <EmptyState title="暂无门店" description="为连锁品牌添加分店营业档案。" />
      ) : (
      ...
      <ConfirmDialog
        danger
        description="删除门店不会删除对应部门，可按需在部门管理中清理。"
