...
export function Textarea({ className, invalid, ...props }: TextareaProps) {
  return (
    <textarea
      className={cn(
        'min-h-24 w-full rounded-md border border-salon-line bg-white px-3 py-2 text-sm text-salon-ink outline-none transition placeholder:text-zinc-400 focus:border-salon-accent focus:ring-2 focus:ring-violet-100 dark:border-zinc-700 dark:bg-zinc-900 dark:text-zinc-100 dark:focus:border-violet-400 dark:focus:ring-violet-900/40',
